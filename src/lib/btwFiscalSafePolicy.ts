...
const RULE_9_GOODS: DutchVatRule[] = [
  { id:'food', pattern:/\b(voedingsmiddel(?:en)?|eetwaren|eten|voedsel|voedingsmiddelen|brood(?:je|jes)?|kaas|melk|yoghurt|kwark|boter|margarine|eieren|ei|fruit|groente(?:n)?|aardappelen|vlees|vis|kip|vleeswaren|snoep(?:goed)?|chocolade|koek(?:jes)?|gebak|taart|chips|pasta|rijst|meel|granen|peulvruchten|noten|pinda(?:'s|s)?|jam|honing|ijsje|ijsjes|voedingspreparaat|voedingssupplement|vitaminen|vitamines|mineralen)\b/i, rate:9, wetsbasis:`${TABLE_I} (voedingsmiddelen).`, label:'Voedingsmiddel/-supplement: 9%-tarief.' },
...
const RULE_21: DutchVatRule[] = [
  { id:'alcohol', pattern:/\b(alcohol|bier|wijn|champagne|prosecco|whisky|whiskey|wodka|vodka|rum|gin|likeur|sterke drank|alcoholische drank|alcoholhoudende drank|mixdrank|advocaat|kruidenwijn)\b/i, rate:21, wetsbasis:`${GENERAL_21}; alcoholhoudende dranken vallen niet onder het 9%-tarief.`, label:'Alcoholhoudende drank: 21%-tarief.' },
