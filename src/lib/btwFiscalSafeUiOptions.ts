...
export const FISCAL_CLASSIFICATION_OPTIONS: FiscalUiOption[] = [
 ...
 {value:'domestic_input_21',label:'Inkoop binnenland — 21% aftrekbaar',sections:'5b',percentage:21},
 {value:'domestic_input_9',label:'Inkoop binnenland — 9% aftrekbaar',sections:'5b',percentage:9},
 ...
 {value:'horeca_bua_9',label:'Horeca — niet aftrekbaar',sections:'geen',percentage:9},
 ...
 {value:'private_no_vat',label:'Privé-uitgave / opname',sections:'geen',percentage:0}
];
