...
assert.throws(()=>calculateFiscalVatReport([{id:'bad',type:'income',amount_incl:100,description:'bad'}],{bad:{classificatie:'eu_reverse_charge',percentage:13,beoordeeld_door:'Boekhouder'}}));
